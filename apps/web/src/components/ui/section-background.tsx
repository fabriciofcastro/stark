    ...
    switch (variant) {
      case "hero":
        return {
          ...
          shapes: [
            ...
            { type: "circle", size: "w-80 h-80", position: "bottom-1/4 right-1/4", color: "accent-500/10" },
            { type: "blob", size: "w-64 h-64", position: "top-1/2 right-1/3", color: "primary-500/5" },
          ],
          pattern: "grid"
        };
      ...
      case "services":
        return {
          ...
          shapes: [
            { type: "circle", size: "w-72 h-72", position: "top-1/3 left-1/6", color: "secondary-400/8" },
            { type: "blob", size: "w-56 h-56", position: "bottom-1/3 right-1/6", color: "accent-400/8" },
          ],
          pattern: "dots"
        };
