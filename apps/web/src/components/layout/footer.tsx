            ...
            <div className="flex flex-wrap items-center justify-center gap-4">
              {[
                ...
                >
                  <Link
                    href={link.href}
                    className="group flex items-center space-x-2 px-4 py-2 rounded-lg bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 transition-all duration-300"
                  >
