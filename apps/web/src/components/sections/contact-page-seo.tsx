...
export const ContactPageSeo = () => {
  const contactData = serviceData(
    "Contato",
    "Entre em contato com a STARK Solutions para obter suporte técnico, consultoria em TI, soluções de infraestrutura e segurança da informação em Itaquaquecetuba - SP.",
  );
