...
const HumanChatbot = ({
	...
	const conversationFlow = [
		{
			id: "welcome",
			message: humanResponses.greeting[Math.floor(Math.random() * humanResponses.greeting.length)],
			options: [
				{ id: "suporte", text: "Preciso de suporte técnico", action: "service", icon: "🔧" },
				{ id: "consultoria", text: "Quero consultoria estratégica", action: "service", icon: "💡" },
				{ id: "nuvem", text: "Soluções em nuvem", action: "service", icon: "☁️" },
				{ id: "seguranca", text: "Cibersegurança", action: "service", icon: "🔒" },
		...
		},
		{
			...
			action: "get_urgency",
			options: [
				{ id: "urgent", text: "🚨 Urgente - Preciso hoje", action: "urgency", icon: "🚨" },
				{ id: "high", text: "⚡ Alta - Esta semana", action: "urgency", icon: "⚡" },
				{ id: "medium", text: "📅 Média - Próximas semanas", action: "urgency", icon: "📅" },
				{ id: "low", text: "💭 Baixa - Apenas consultoria", action: "urgency", icon: "💭" },
			],
		},
		{
			id: "urgency",
		...
		},
		{
			...
			options: [
				...
				{ id: "agendar", text: "📅 Agendar uma reunião", action: "schedule", icon: "📅" },
				{ id: "email", text: "📧 Enviar proposta por e-mail", action: "email", icon: "📧" },
				{ id: "escalate", text: "👨‍💼 Falar com especialista", action: "escalate", icon: "👨‍💼" },
			],
		},
	];
