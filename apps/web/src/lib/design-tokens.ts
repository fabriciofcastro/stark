...
export const designTokens = {
	...
	gradients: {
		primary:
			"linear-gradient(135deg, hsl(210, 100%, 60%) 0%, hsl(210, 100%, 40%) 100%)",
		secondary:
			"linear-gradient(135deg, hsl(45, 100%, 50%) 0%, hsl(45, 100%, 30%) 100%)",
		accent:
			"linear-gradient(135deg, hsl(160, 100%, 50%) 0%, hsl(160, 100%, 30%) 100%)",
		neutral:
			"linear-gradient(135deg, hsl(0, 0%, 90%) 0%, hsl(0, 0%, 70%) 100%)",
