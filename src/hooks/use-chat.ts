...
export const useChat = (options: UseChatOptions = {}) => {
  ...
  const handleContactFormSubmit = useCallback((data: Record<string, unknown>) => {
  ...
  const getCustomMessage = useCallback(() => {
    ...
    const pageMessages: Record<string, string> = {
      "suporte-tecnico": "Olá! Preciso de suporte técnico para minha empresa. Pode me ajudar?",
      "consultoria-tecnologica": "Olá! Gostaria de uma consultoria tecnológica estratégica. Podemos conversar?",
      "cloud-vps-linux": "Olá! Estou interessado em soluções de nuvem e VPS. Pode me ajudar?",
      "cyberseguranca": "Olá! Preciso de serviços de cibersegurança. Podemos conversar?",
      "helpdesk": "Olá! Preciso de um help desk para minha empresa. Pode me ajudar?",
      "governance": "Olá! Gostaria de implementar governança de TI. Podemos conversar?",
      "create-site": "Olá! Preciso criar um site para minha empresa. Pode me ajudar?",
      "contact": "Olá! Gostaria de entrar em contato com a STARK. Pode me ajudar?",
      "sobre": "Olá! Gostaria de saber mais sobre a STARK. Podemos conversar?",
      "services": "Olá! Gostaria de conhecer os serviços da STARK. Pode me ajudar?",
      "portfolio": "Olá! Gostaria de ver o portfólio da STARK. Pode me ajudar?",
      "cases-de-sucesso": "Olá! Gostaria de conhecer os cases de sucesso da STARK. Pode me ajudar?",
      "faq": "Olá! Tenho algumas dúvidas sobre os serviços da STARK. Pode me ajudar?",
    };

    return pageMessages[pageName || ""] || "Olá! Gostaria de saber mais sobre os serviços da STARK. Pode me ajudar?";
  }, [customMessage, pageName]);

  // Função para abrir WhatsApp com mensagem personalizada
  const openWhatsApp = useCallback((message?: string) => {
    const whatsappNumber = process.env.NEXT_PUBLIC_WHATSAPP_NUMBER || "+5511994396469";
