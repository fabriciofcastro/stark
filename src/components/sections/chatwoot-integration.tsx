	...
	useEffect(() => {
		...
		script.onload = () => {
			...
			if (window.chatwootSDK) {
				...
				// setCustomAttributes pode não estar disponível em todas as versões
				if (typeof window.chatwootSDK.setCustomAttributes === "function") {
				...
				// Event listeners para tracking (verificar se existem)
				if (typeof window.chatwootSDK.on === "function") {
