...
const ModernHeader = () => {
	...
	return (
		<>
			...
			>
				{/* Background com glassmorphism - apenas quando não está scrolled */}
				{!isScrolled && (
					<motion.div
												...
												>
													...
													>
														<div className="flex items-start space-x-4">
															<div
																className={`p-3 rounded-lg bg-${service.color}-500/20 group-hover:bg-${service.color}-500/30 transition-colors duration-300`}
															>
																<IconComponent
																	className={`w-6 h-6 text-${service.color}-400`}
																/>
															</div>
