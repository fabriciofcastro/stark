...
const ServicesDropdown = ({
	...
	return (
		<div className="relative">
			<Link
				href="/services"
				className={`text-white link-brand px-2 py-2 rounded ${isActive ? "is-active" : ""}`}
				aria-haspopup="menu"
			...
			<AnimatePresence>
				{isOpen && (
					<motion.div
						...
						className="absolute left-1/2 -translate-x-1/2 mt-3 w-[min(95vw,700px)] sm:w-[min(92vw,800px)] rounded-xl gold-border-animated bg-[hsl(var(--brand-green-800))]/95 backdrop-blur-md p-[1px] z-30"
						onMouseEnter={onOpen}
						onMouseLeave={onCloseSchedule}
									...
									return (
										...
										>
											<Link
												href={service.href}
												role="menuitem"
												className="group relative flex items-center gap-3 sm:gap-4 p-3 sm:p-4 rounded-lg transition-all duration-300 hover:bg-gradient-to-r hover:from-white/5 hover:to-transparent hover:shadow-lg hover:shadow-white/10 border border-transparent hover:border-white/20 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-gold-500/50"
											>
