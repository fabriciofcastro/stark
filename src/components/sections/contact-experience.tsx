...
const ContactExperience = ({
  ...
  const handleContactRequest = (data: { name: string; email: string; phone: string; service: string }) => {
      ...
      {showSuccess && (
        ...
        >
          <div className="flex items-center space-x-2">
            ...
            <span className="font-medium">Informações coletadas! Entraremos em contato em breve.</span>
          </div>
        </motion.div>
      )}
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 p-4 z-40 md:hidden">
        <div className="flex justify-around">
          ...
          <motion.button
            ...
            onClick={() => handleWhatsAppRedirect("Olá! Gostaria de saber mais sobre os serviços da STARK.")}
          >
            <div className="w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center">
          ...
          <motion.button
            ...
            onClick={() => window.open("https://calendly.com/stark-tecnologia", "_blank")}
          >
            <div className="w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center">
