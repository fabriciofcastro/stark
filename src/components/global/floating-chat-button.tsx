          ...
          >
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-brand-gold-100 text-xs">Escolha uma opção</p>
                  </div>
                </div>
                <button
                  type="button"
            ...
            <div className="p-4 space-y-2">
              ...
              >
                ...
                <div>
                  <div className="font-medium text-sm text-gray-900">Chat Online</div>
              ...
              >
                ...
                <div>
                  <div className="font-medium text-sm text-gray-900">WhatsApp</div>
              ...
              >
                ...
                <div>
                  <div className="font-medium text-sm text-gray-900">Formulário</div>
                  <div className="text-xs text-gray-500">Envie sua mensagem</div>
                </div>
              </button>
              ...
              >
                ...
                <div>
                  <div className="font-medium text-sm text-gray-900">Agendar</div>
                  <div className="text-xs text-gray-500">Marque uma reunião</div>
                </div>
              </button>
            </div>
          </motion.div>
